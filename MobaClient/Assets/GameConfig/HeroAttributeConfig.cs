...
public class HeroAttributeConfig
{
    ...
    static HeroAttributeConfig()
    {
       ...
       HeroAttributeEntity1.Occupation = @"法師";
       ...
       HeroAttributeEntity2.HeroName = @"師子";
       ...
       HeroAttributeEntity3.HeroName = @"廣持";
       HeroAttributeEntity3.Occupation = @"法師";
       ...
       HeroAttributeEntity4.HeroName = @"張武";
       HeroAttributeEntity4.Occupation = @"法師";
